	...
	<div class="col-lg-12">
        ...
        if (isset($_POST['submit'])) {
        	...
        	if ($_POST['id']!='') { // edit record
        		...
        		$sql = "UPDATE tbl_job SET jobName='".$_POST['jobName']."' WHERE id='".$_POST['id']."'";
        		$res = updateData($sql);	
        		...
        		$sql = "INSERT INTO tbl_job VALUES (null,'".$_POST['jobName']."')";
        		$res = insertData($sql);
        	...
        	$sql = "DELETE FROM tbl_job WHERE id='".$_GET['delete-id']."'";
        ...
        <?php
        $stmt = "SELECT * FROM tbl_job
        ORDER BY tbl_job.jobName DESC";
                    ...
                    <td align="center">
                        <div class="btn-group">
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuReference1">
                                ...
                                <a class="dropdown-item" href="index.php?admin=list_job&delete-id=<?php echo $value['id'];?>" onclick="return confirm('Hapus rekod ini?');">Hapus</a>
                            </div>
                        </div>
                    </td>
                </tr>
