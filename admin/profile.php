	...
	<div class="col-lg-12">
        ...
        <div class="widget-header">
        	...
        	<div class="row">
        		...
        		<tr>
        		<td width="15%"><b>NO. PEKERJA<b></td>
        		<td width="85%"><?php echo $res['username'];?></td>
        		</tr>
        		
        		<tr>
        		<td width="15%"><b>NAMA<b></td>
        		<td width="85%"><?php echo $res['fullname'];?></td>
        		</tr>
        		...
        		<tr>
        		<td width="15%"><b>JAWATAN</b></td>
        		<td width="85%"><?php echo $res4['positionName'];?></td>
        		</tr>
        		
        		<tr>
        		<td width="15%"><b>PERANAN</b></td>
        		<td width="85%"><?php echo $res3['levelName'];?></td>
        		</tr>
        		
        		<tr>
        		<td width="15%"><b>ALAMAT</b></td>
        		<td width="85%"><?php echo $res['address1']."&nbsp;&nbsp;".$res['postcode']."&nbsp;&nbsp;".$res1['districtName']."&nbsp;&nbsp;".$res2['stateName'];?></td>
        		</tr>
...
<div class="modal fade bd-example-modal-lg<?php echo $res['userID'];?>" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
	<div class="modal-dialog modal-lg" role="document">
        ...
        <form name="" action="index.php?admin=profile" method="post">
