	...
	<div class="col-lg-12">
        ...
        if (isset($_POST['submit'])) {
        	...
        	if ($_POST['id']!='') { // edit record
        		...
        		$sql = "UPDATE tbl_religion SET religionName='".$_POST['religionName']."' WHERE id='".$_POST['id']."'";
        		$res = updateData($sql);	
        		...
        		$sql = "INSERT INTO tbl_religion VALUES (null,'".$_POST['religionName']."')";
        		$res = insertData($sql);
        	...
        	$sql = "DELETE FROM tbl_religion WHERE id='".$_GET['delete-id']."'";
        ...
        <?php
        $stmt = "SELECT * FROM tbl_religion
        ORDER BY tbl_religion.religionName DESC";
        ...
        if ($result!='') {
            ...
            foreach ($result as $value) {
                ...
                <tr>
                    <td><?php echo $i;?></td>
                    <td><?php echo $value['religionName'];?></td>
                    <td align="center">
                        <div class="btn-group">
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuReference1">
                                ...
                                <a class="dropdown-item" href="index.php?admin=list_religion&delete-id=<?php echo $value['id'];?>" onclick="return confirm('Hapus rekod ini?');">Hapus</a>
                            </div>
                        </div>
                    </td>
                </tr>
...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
	<div class="modal-dialog" role="document">
    	<div class="modal-content">
            ...
            <form name="" action="index.php?admin=list_religion" method="post">
