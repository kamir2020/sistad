	...
	<div class="col-lg-12">
        ...
        if (isset($_POST['submit'])) {
        	...
        	if ($_POST['id']!='') { // edit record
        		...
        		$sql = "UPDATE tbl_ziarah SET name='".$_POST['name']."',locationName='".$_POST['locationName']."',
        	...
        	$sql = "DELETE FROM tbl_ziarah WHERE id='".$_GET['delete-id']."'";
        ...
        <?php
        $stmt = "SELECT tbl_ziarah.id,tbl_ziarah.name,tbl_ziarah.locationName,
        tbl_ziarah.dateStart,tbl_ziarah.dateEnd,tbl_ziarah.statusID,
        tbl_status.statusName
        	FROM tbl_ziarah 
        		INNER JOIN tbl_status ON tbl_ziarah.statusID=tbl_status.id";
            ...
            foreach ($result as $value) {
                ...
                <tr>
                    ...
                    <td align="center">
                        ...
                        <a href="index.php?pt=list_ziarah&delete-id=<?php echo $value['id'];?>" data-toggle="tooltip" data-placement="top" title="Hapus" onclick="return confirm('Hapus rekod ini?');"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-trash-2 text-danger"><polyline points="3 6 5 6 21 6"></polyline><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"></path><line x1="10" y1="11" x2="10" y2="17"></line><line x1="14" y1="11" x2="14" y2="17"></line></svg></a>
                    </td>
                </tr>
                <?php
                
                include "edit_ziarah.php";
